...
| Process / Material                       | Rate / Parameter                                               | Note                                                                                                                                                                                                                                                                |
| :------------------------------------- | :----------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Photoresist Coating**                | **0.05 $\mu m$ to 100 $\mu m$**.                             |                                                                                                                                                                                                                                                                     | Directly supported by the current sources. |
| **PVD Evaporation**                    | 0.1-1 nm/s                                                   | This specific numerical rate was mentioned in the previous summary in our conversation history, but it is not directly supported by the details provided in the current source documents. You may want to independently verify this information.                    |
| **PVD Sputtering**                     | 1-10 nm/s                                                    | This specific numerical rate was mentioned in the previous summary in our conversation history, but it is not directly supported by the details provided in the current source documents. You may want to independently verify this information.                    |
| **CVD Polysilicon from Silane (SiH4)** | Approximately **10 nm/min** at 630°C and 400 mTorr           | This specific numerical rate and conditions were mentioned in the previous summary in our conversation history, but they are not directly supported by the details provided in the current source documents. You may want to independently verify this information. |
| **Dry Oxidation**                      | About **0.5 $\mu m$** in approximately **6 hours** at 1200°C | This specific numerical rate and conditions were mentioned in the previous summary in our conversation history, but they are not directly supported by the details provided in the current source documents. You may want to independently verify this information. |
| **Wet Oxidation**                      | About **0.5 $\mu m$** in approximately **1 hour** at 1200°C  | This specific numerical rate and conditions were mentioned in the previous summary in our conversation history, but they are not directly supported by the details provided in the current source documents. You may want to independently verify this information. |

Table about etching:

| Process / Material                                | Rate / Parameter                              | Note                                                                                                                                                                                                                                             |
| :---------------------------------------------- | :------------------------------------------ | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Wet Etching (HF 49% for SiO2 / PSG)**           | Greater than **1 $\mu m$/min**              | This specific numerical rate was mentioned in the previous summary in our conversation history, but it is not directly supported by the details provided in the current source documents. You may want to independently verify this information. |
| **Wet Etching (Dilute HF 1% for native oxide)** | Approximately **10 nm/min**                 | This specific numerical rate was mentioned in the previous summary in our conversation history, but it is not directly supported by the details provided in the current source documents. You may want to independently verify this information. |
| **Wet Etching (Silicon with HNO3 : HF : CH3COOH)**  | Greater than **10 $\mu m$/min** is possible | This specific numerical rate was mentioned in the previous summary in our conversation history, but it is not directly supported by the details provided in the current source documents. You may want to independently verify this information. |
| **Deep Reactive Ion Etching (DRIE)**            | Can be greater than **10 $\mu m$/min**      | This specific numerical rate was mentioned in the previous summary in our conversation history, but it is not directly supported by the details provided in the current source documents. You may want to independently verify this information. |
